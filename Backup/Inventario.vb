...
Erro:
        ...
        ArquivoInventario = "\Honeywell\davo\aplicacoes\COLINV\OUT\TASK" & dtNOW & "-" & mnTaskID.ToString.PadLeft(6, "0") & "-" & mnInventario.ToString.PadLeft(5, "0") & "-" & mnArea.ToString.PadLeft(3, "0") & "-" & mnContador & ".TXT"
...
Erro:
    ...
    Sub pesquisaProduto(ByVal szProduto)
        ...
        Dim fileName = "\Honeywell\davo\aplicacoes\COLINV\IN\Produtos.txt"
